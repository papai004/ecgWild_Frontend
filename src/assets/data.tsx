...
export const Heading = "Our Projects";
export const Paragraph = "Join our mission to document climate change impacts and inspire actionable solutions through scientific expeditions.";
